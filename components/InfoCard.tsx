...
export default function InfoCard({ icon: Icon, title, children }: InfoCardProps) {
  return (
    <div className="bg-card border border-border rounded-[var(--radius-xl)] p-8 text-center space-y-4 shadow-sm hover:border-primary/50 hover:shadow-md transition-all duration-300">
